...
export CPPFLAGS="-I$PWD/../dbgflags/include -I$TAO_ROOT/include -I$ACE_TAO_HOME/include -I$TAO_ROOT/orbsvcs -I$ACE_TAO_HOME/include/TAO $CPPFLAGS"

export LDFLAGS="-L$PWD/../dbgflags/libdbgflags/.libs -L$ACE_TAO_HOME/lib $LDFLAGS"
export LD_LIBRARY_PATH=$PWD/../dbgflags/libdbgflags/.libs:$LD_LIBRARY_PATH
...
./configure  --enable-corba --enable-debug --enable-CORBA-kind=no --enable-XWindows-Management && make && make dist && make dist-bin-rpm
